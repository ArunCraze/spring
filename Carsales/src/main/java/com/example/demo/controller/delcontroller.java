...
public class delcontroller {
	...
	@PostMapping("")
	public cardel saveDetails(@RequestBody cardel cs)
	{
	...
	@PutMapping("")
	public cardel updateDetails(@RequestBody cardel cup)
	{
	...
	public List<cardel> getbyid(@PathVariable int id)
	{
	...
	public List<cardel> getbybetween(@PathVariable int start,@PathVariable int end)
	{
	...
	//JPQL
		...
		public List<cardel> getJPQLbname(@PathVariable("cname") String cname)
		{
		...
		public List<cardel> jpqlbetween(@PathVariable("start") int start,@PathVariable("end") int end)
		{
