...
import com.example.demo.service.priceserivce;
...
public class pricecontroller {
	...
	@PostMapping("")
	public carprice saveDetails(@RequestBody carprice as)
	{
	...
	@PutMapping("")
	public carprice updateDetails(@RequestBody carprice aup)
	{
	...
	public List<carprice> getbyid(@PathVariable int id)
	{
	...
	public List<carprice> getbybetween(@PathVariable int start,@PathVariable int end)
	{
	...
	//JPQL
			...
			public List<carprice> getJPQLbname(@PathVariable String bname)
			{
			...
			public List<carprice> jpqlbetween(@PathVariable int start,@PathVariable int end)
			{
